...
#define SCREEN_WORLD_SELECT_NUM_PAGES       3
#define SCREEN_WORLD_SELECT_NUM_CHOICES     4

#define SCREEN_ROOM_SELECT_NUM_ALTERNATES   12
#define SCREEN_ROOM_SELECT_NUM_CHOICES      8

#define SCREEN_STORY_SELECT_NUM_CHOICES     4

#define SCREEN_STORY_SCENE_NUM_ALTERNATES   4
